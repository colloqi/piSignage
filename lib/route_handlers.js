...
exports.noticeSave = function(req, res){    
    ...
    if(data.image){
        ...
        template= '<div style="padding:0 40px;"><p><pre style="white-space:pre-wrap;font-size:15px;">'+data.description+'<pre></p></div>';
    }
    var pagedata= '<div style="margin-top: 10%;height:85%; background: -webkit-linear-gradient(left, #E6ECEC, #FFFFFF);background: linear-gradient(#E6ECEC, #FFFFFF);">'+
                    '<h1 style="text-align:center"> '+ data.title +' </h1> '+ template +
                  '</div>'
