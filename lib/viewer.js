...
var browser, currentBrowserUrl,browserReady=true,browserCommand,
...
function browserSend (cmd) {
    ...
    if (browser) {
        try {
            browserReady = false;
            setTimeout(function(){browserReady=true},3000);     //after timeout make it true if event does not occur
