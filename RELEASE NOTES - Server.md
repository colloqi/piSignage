...
#### 5.3.5   Server Release
1. Improved server performance on large installations
2. Disabled or deleted players now clear their local log files after upload instead of letting them grow
3. Event retention
