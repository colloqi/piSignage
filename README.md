...
1. Download the **[1.2.6 stable](https://s3.amazonaws.com/pisignage/pisignage-images/pisignage_1.2.6.img.zip)** or **[1.4.1 latest (Raspbian Jessie based)](https://s3.amazonaws.com/pisignage/pisignage-images/pisignagepro_1.4.1_jessie.img.zip)** complete piSignage player image 
