...
1. Download the complete piSignage player iso image, both support pi 3B+ (please unzip and program the SD card)
    -  **[ 2.1.0 (updated v2) based on latest raspbian 06-27-2018 image ](https://s3.amazonaws.com/pisignage/pisignage-images/pisignage_2.1.0.img.zip )**
        -   [GDrive link for 2.1.0](https://drive.google.com/open?id=14jj2XLsaejhZZ9nJMcEiBd56ZmCwBv4b)
