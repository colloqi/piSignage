...
1. Download the complete piSignage player iso image, both support pi 3B+ (please unzip and program the SD card)
    -  **[ 2.2.1 based on latest raspbian 06-27-2018 image ](https://s3.amazonaws.com/pisignage/pisignage-images/pisignage_2.2.1.img.zip )**
        -   [GDrive link for 2.2.1](https://drive.google.com/file/d/11PtFtwsv1TfwXb5XmtM1NZDCVkLWjfJr/view?usp=sharing)
    -  **[ 1.9.9aa stable](https://s3.amazonaws.com/pisignage/pisignage-images/pisignage_1.9.9aa.img.zip )**
